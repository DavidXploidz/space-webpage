  ...
  return (
    ...
    <div className='header-destination'>
      <div className='contenedor flex items-center gap-x-5 text-4xl text-left '>
        <p className='font-bold text-gray-600 mt-96'>01</p>
        <span className='text-white uppercase tracking-widest mt-96'>pick your destination</span>
      </div>
        ...
        {datos.destinations.map((planetas, index) => {
          if(planetas.name === valor){
            return (
              <>
              <div className='contenedor flex gap-x-96 ' key={index}  >
                <img src={planetas.images.webp} alt={`Imagen de ${planetas.name}`} className="mt-20 ml-56" />
                <div className=' text-left mt-20 '>
                  ...
                  <div>
                    ...
                    <p className='w-full bg-gray-500 h-px mt-28 mb-10'></p>
                  </div>
                  
                  <div className='flex justify-start gap-x-40 my-10'>
                    <div>
